...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { id: 3, text: 'Dashboard', link: '/loggedin/dashboard' },
    { id: 4, text: 'Journal', link: '/loggedin/journal' },
    { id: 5, text: 'Chatbot', link: 'https://wellnest-chat-bot.onrender.com/', external: true },
  ];
